...
const LIGHT = {
  ...
  ADM:      { bg: '#dcfce7', color: '#15803d', dot: '#16a34a' },
  UP:       { bg: '#ede9fe', color: '#6d28d9', dot: '#8b5cf6' },
  UC:       { bg: '#f1f5f9', color: '#475569', dot: '#64748b' },
  UE:       { bg: '#ecfdf5', color: '#047857', dot: '#10b981' },
...
const DARK = {
  ...
  ADM:      { bg: '#052e16', color: '#4ade80', dot: '#16a34a' },
  UP:       { bg: '#2e1065', color: '#a78bfa', dot: '#8b5cf6' },
  UC:       { bg: '#1e293b', color: '#94a3b8', dot: '#64748b' },
  UE:       { bg: '#064e3b', color: '#34d399', dot: '#10b981' },
